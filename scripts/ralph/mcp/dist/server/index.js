...
import { initTelemetry, shutdownTelemetry, DEFAULT_IDLE_TIMEOUT_MS, } from '../shared/index.js';
import { handleToolCall, getToolDefinitions } from './tools/index.js';
const SERVER_NAME = 'ralph-mcp';
const SERVER_VERSION = '1.0.0';
// Idle timeout management
let idleTimer = null;
const IDLE_TIMEOUT_MS = parseInt(process.env.RALPH_MCP_IDLE_TIMEOUT || String(DEFAULT_IDLE_TIMEOUT_MS), 10);
