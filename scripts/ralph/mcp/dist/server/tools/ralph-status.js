import { z } from 'zod';
import { getAllInstances, getPrdProgress, readLocks, } from '../services/state-reader.js';
...
// Tool definition
export const ralphStatusDefinition = {
    name: 'ralph_status',
...
// Tool handler
export const ralphStatusHandler = async (args) => {
    try {
        ...
        return jsonResponse({
            ...
            summary: {
                ...
                activeInstances: formattedInstances.filter(i => !i.isDead && !['completed', 'terminated'].includes(i.state)).length,
...
//# sourceMappingURL=ralph-status.js.map